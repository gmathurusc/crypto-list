    ...
    BootstrapTable.prototype.addLevel = function(index, sortPriority) {
        ...
        $.each(this.columns, function(i, column) {
            ...
            if(!isHideShowColumnsDivAppended) {
                $hideShowColumns.append('<div class="pretty p-svg p-curve col-md-5 col-sm-6 col-xs-12" style="margin-top:5px;margin-bottom:5px; color: #1F2739">'+
                    '<input type="checkbox" id="' + column.field + '" checked/>'+
